...
// update
///////////////////////////////////////////////////////////////////////////////
var doUpdateRelease = async function (options, projectContext, releaseName, releaseRecord) {
...
var maybeUpdateRelease = async function (options) {
  ...
  if (release.current && release.current.isCheckout()) {
    ...
    await doUpdateRelease(options, projectContext, null, (await newIsopacketBuildingCatalog()).getReleaseRecord());
    return 0;
  }
  ...
  await doUpdateRelease(options, projectContext, releaseName, releaseRecord);
